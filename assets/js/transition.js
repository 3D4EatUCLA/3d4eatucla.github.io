(function () {
    ...
    function generateZigZag(nozzleName, clipName, fromBot, toBot, startRight) {
        ...
        for (let i = 0; i < LAYERS; i++) {
            ...
            if (i === 0) kfNozzle += ` ${t_start}% {transform: translate(${x1}, -${bot_current}lvh);}\n`;
            kfNozzle += ` ${t_sweep_end}% {transform: translate(${x2}, -${bot_current}lvh);}\n`;
            kfNozzle += ` ${t_end}% {transform: translate(${x2}, -${bot_next}lvh);}\n`;
